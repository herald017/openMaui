...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"69efa376-4a7d-40d5-8262-c624df8a6695\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [25 x i8] c"com.companyname.openmaui\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100671995, ; jnienv_initialize_method_token
	i32 100671994, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.44 = internal constant [23 x i8] c"libaot-OpenMaui.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 52
	%struct.DSOCacheEntry {
		i64 2351177839742136955, ; hash 0x20a10fc9c599b27b, from name: libaot-OpenMaui.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 53
	%struct.DSOCacheEntry {
	...
	; 73
	%struct.DSOCacheEntry {
		i64 3204467492435312791, ; hash 0x2c788e34d4e4c097, from name: libaot-OpenMaui
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 109
	%struct.DSOCacheEntry {
		i64 4607812386075024489, ; hash 0x3ff23cf3afa59c69, from name: OpenMaui.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 125
	%struct.DSOCacheEntry {
		i64 5492222551828939447, ; hash 0x4c384b4fd52742b7, from name: OpenMaui
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 132
	%struct.DSOCacheEntry {
		i64 6157519023109100351, ; hash 0x5573e6ed7620d33f, from name: aot-OpenMaui.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 323
	%struct.DSOCacheEntry {
		i64 13136020063524144091, ; hash 0xb64c84a670c2c3db, from name: aot-OpenMaui
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
